    ...
    <table id="ejercicios" class="display">
        ...
        <tbody>
            <?php while ($row = $result->fetchArray(SQLITE3_ASSOC)) { ?>
                <tr>
                    <td><?php echo htmlspecialchars($row['nombre_ejercicio']); ?></td>
                    <td><?php echo htmlspecialchars($row['descripcion_ejercicio']); ?></td>
                    <td>
                        <?php if (!empty($row['url_imagen_ejercicio'])) { ?>
                            <img src="data:image/jpeg;base64,<?php echo base64_encode($row['url_imagen_ejercicio']); ?>" alt="Imagen Ejercicio" style="width:100px;">
                        <?php } else { ?>
                    ...
                    <td>
                        <?php if (!empty($row['url_video_ejercicio'])) { ?>
                            <iframe width="200" height="113" src="https://www.youtube.com/embed/<?php echo htmlspecialchars(getYouTubeID($row['url_video_ejercicio'])); ?>" frameborder="0" allowfullscreen></iframe>
                        <?php } else { ?>
                            <span>No disponible</span>
                        <?php } ?>
                    </td>
